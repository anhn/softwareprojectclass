...
with tab2:
    ...
    st.image(image, width=800,caption='Figure 1 - Which Design law this image illustrate?')
    image = Image.open('photo/law2.jpg')
    st.image(image, width=800,caption='Figure 2 - Which Design law this image illustrate?')
